      ...
      <div className="flex flex-col flex-wrap gap-3 sm:gap-4 sm:flex-row sm:items-stretch">
            ...
            <CarteEntete>
              <div className="flex items-center gap-3">
                <div className="flex size-10 items-center justify-center rounded-xl bg-emerald-500/15 dark:bg-[var(--accent-principal)]/18">
                  <FileText className="size-5 text-emerald-600 dark:text-[var(--accent-principal)]" />
                </div>
                <div>
        ...
        >
          <Carte className="relative h-full overflow-hidden">
            ...
            <CarteEntete>
              <div className="flex items-center gap-3">
                <div className="flex size-10 items-center justify-center rounded-xl bg-amber-500/15 dark:bg-[var(--accent-principal)]/18">
                  <CalendarOff className="size-5 text-amber-700 dark:text-[var(--accent-principal)]" />
                </div>
                <div>
